...
import com.watermark.platform.filter.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtAuthFilter jwtAuthFilter, CustomDetailsUserService customDetailsUserService) {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/authenticate", "/refresh", "/h2-console/**").permitAll()
